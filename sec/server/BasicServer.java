...
public class BasicServer implements AutoCloseable {
    ...
    public void registerHandler(MsgType msgType, BasicMessageHandler handler) {
    ...
    public interface BasicMessageHandler {
        void handle(
                ...
                throws IOException, IllegalBlockSizeException, BadPaddingException, NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException, ClassNotFoundException, InvalidKeySpecException;
    }
